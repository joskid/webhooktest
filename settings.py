...
DATABASES = {
    'default': {
        ...
        'NAME': 'webhooktest.db',                      # Or path to database file if using sqlite3.
        'USER': '',                      # Not sused with sqlite3.
...
SECRET_KEY = 'no4_xa7!qfa%a$fr@_)l4$hl8-euek050c%3)ej)aw^w6ep5od'
...
MIDDLEWARE_CLASSES = (
    ...
    'postlog.middleware.NginxMiddleware',
)
